...
function Awake () {
	...
	otherTexts[96] = "SEREIA: Eu e minhas companheiras os resgatamos. Os outros piratas estão bem.";
	...
	otherTexts[104] = "MAELZEL: Ora essa garoto, não fique aí de namoricos. Não temos tempo a perder.";
	otherTexts[105] = "TOM: Mas…";
	otherTexts[106] = "MAELZEL: Venha logo, pegue seu teclado e ajuste a musikinésis com o meu metrônomo.";
	otherTexts[107] = "TOM: Mas…";
	otherTexts[108] = "TOM: Mas espera aí… não saio daqui antes de você me contar sobre como conheceu meu avô.";
	otherTexts[109] = "MAELZEL: Outra hora, garoto. Preciso voltar logo ao meu restaurante. Provavelmente aquele guloso do Macarroni já deve ter roubado toda minha clientela.";
	otherTexts[110] = "TOM: Tudo bem, não me importo de passar o resto de minha vida aqui. Hey sereia… espere!";
	otherTexts[111] = "MAELZEL: Ahhhh tudo bem, garoto teimoso.";
	otherTexts[112] = "MAELZEL: Cansado de viver em Viena, me mudei para Paris com a esperança de que meus inventos musicais fossem mais reconhecidos.";
	otherTexts[113] = "MAELZEL: Como estava precisando comprar peças para produzir meu mais novo invento, o metrônomo, fui até uma loja de materiais musicais de um tal de Isaac Diapasão. Foi aí que conheci seu avô.";
	otherTexts[114] = "MAELZEL: Tínhamos muitos interesses em comum sobre música e ciência, e em pouco tempo nos tornarmos grandes amigos.";
	otherTexts[115] = "MAELZEL: Ele havia me contado que estava trabalhando em um invento que revolucionaria o mundo da música por meio da influência das frequências sonoras no espaço-tempo.";
	otherTexts[116] = "MAELZEL: Foi aí que criou um teclado capaz de manipular objetos através dos sons emitidos pelo instrumento. Este mesmo que agora está com você.";
	otherTexts[117] = "TOM: Mas espera aí. Em que ano foi isso?";
	otherTexts[118] = "MAELZEL: 1816.";
	otherTexts[119] = "TOM: O QUE?";
	otherTexts[120] = "MAELZEL: Por que acha que não uso essas imitações baratas de metrônomos digitais?.";
	otherTexts[121] = "TOM: Mas como pode? Como você ainda está vivo???";
	otherTexts[122] = "MAELZEL: Vamos, me deixe terminar, garoto…";
	otherTexts[123] = "MAELZEL: Quando Isaac foi testar o teclado, ele pediu minha ajuda para medir o tempo com o metrônomo.";
	otherTexts[124] = "MAELZEL: Mas por alguma razão desconhecida, o experimento acidentalmente alterou os paradigmas de espaço-tempo, influenciando na variação temporal e fazendo-nos viajar no tempo.";
	otherTexts[125] = "MAELZEL: Fui parar na sua cidade e no seu tempo. Tudo que eu tinha era minha roupa do corpo e meu metrônomo.";
	otherTexts[126] = "MAELZEL: Foi daí que tive a ideia de abrir o restaurante para sobreviver. Como meu metrônomo foi infectado pela magia do teclado, tenho o poder de acelerar o tempo. Fiz muito dinheiro com meu Presto Pasta e desbamquei o velho Macarroni.";
	otherTexts[127] = "MAELZEL: Mas e meu avô? Então quer dizer que ele está vivo?";
	otherTexts[128] = "MAELZEL: Provavelmente seu avô encontra-se preso em alguma fenda temporal que foi aberta acidentalmente nessa viagem. Se ele está vivo, não posso garantir...";
